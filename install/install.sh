...
# Slack for private usage
export WODSLACK_BOT_TOKEN=${WODSLACK_BOT_TOKEN:='TBD'}
export WODSLACK_TEAM_ID=${WODSLACK_TEAM_ID:='TBD'}
export WODSLACK_INVITE_CHANNEL_IDS=${WODSLACK_INVITE_CHANNEL_IDS:='TBD'}
...
export WODSLACK_BOT_TOKEN="$WODSLACK_BOT_TOKEN"
export WODSLACK_TEAM_ID="$WODSLACK_TEAM_ID"
export WODSLACK_INVITE_CHANNEL_IDS="$WODSLACK_INVITE_CHANNEL_IDS"
...
EOF
    ...
    su - $WODUSER -w WODGROUP,WODFEFQDN,WODBEFQDN,WODAPIDBFQDN,WODFEEXTFQDN,WODBEEXTFQDN,WODAPIDBEXTFQDN,WODTYPE,WODBEEXTIP,WODDISTRIB,WODDISTRIBNAME,WODUSER,WODFEREPO,WODBEREPO,WODAPIREPO,WODNOBOREPO,WODPRIVREPO,WODINSREPO,WODFEBRANCH,WODBEBRANCH,WODAPIDBBRANCH,WODNOBOBRANCH,WODPRIVBRANCH,WODINSBRANCH,WODSENDER,WODGENKEYS,WODINSECURE,WODTMPDIR,WODFEPORT,WODBEPORT,WODAPIDBPORT,WODFEEXTPORT,WODBEEXTPORT,WODAPIDBEXTPORT,WODFEPROTO,WODBEPROTO,WODAPIDBPROTO,WODFEEXTPROTO,WODBEEXTPROTO,WODAPIDBEXTPROTO,WODPOSTPORT,WODBENBR,WODSENDGRIDAPIKEY,WODDENYLIST,WODSLACK_BOT_TOKEN,WODSLACK_TEAM_ID,WODSLACK_INVITE_CHANNEL_IDS,WODPGUSER,WODPGPASSWD,WODPGDB,WODAPIDBUSER,WODAPIDBUSERPWD,WODAPIDBADMIN,WODAPIDBADMINPWD -c "$EXEPATH/install-system-common.sh"
fi
